...
function ComItem(_ref) {
  ...
  var actions = function actions(item) {
    ...
    }, likeCount)), /*#__PURE__*/_react["default"].createElement("span", {
      key: "comment-basic-reply-to",
      onClick: handleChangeComFormStatus.bind(_this, item.id)
    }, "\u56DE\u590D"), item.children && item.children.length > 0 && /*#__PURE__*/_react["default"].createElement(_antd.Button, {
      size: "small",
      style: {
        fontSize: 12
      },
  ...
  var Comments = function Comments(_ref2) {
    var item = _ref2.item;
    return /*#__PURE__*/_react["default"].createElement(_antd.Comment, {
      actions: actions(item),
      author: /*#__PURE__*/_react["default"].createElement("a", null, item.nickname),
      avatar: /*#__PURE__*/_react["default"].createElement(_antd.Avatar, {
        src: item.avatar,
        alt: "Han Solo"
      }),
      content: /*#__PURE__*/_react["default"].createElement("p", null, item.content),
      datetime: /*#__PURE__*/_react["default"].createElement(_antd.Tooltip, {
    ...
    }, item.id == comFormId && /*#__PURE__*/_react["default"].createElement(_component.OuterClickWrapper, {
      onClick: function onClick() {
        return setComFormId(undefined);
      }
    }, /*#__PURE__*/_react["default"].createElement(_ComForm["default"], {
      parentId: item.id,
      articleId: item.articleId
    })), item.children && item.children.length > 0 && openState[item.id] && item.children.map(function (item) {
      return /*#__PURE__*/_react["default"].createElement(Comments, {
        item: item,
        key: item.id
      });
    }));
