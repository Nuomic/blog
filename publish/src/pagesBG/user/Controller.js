...
function (_Controller) {
  ...
  function _default() {
    ...
    _defineProperty(_assertThisInitialized(_this), "handelGetSetting", function _callee(type, fun) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleSaveSetting", function _callee2(type, value) {
